...
let APP_MODULE = (function () {
  ...
  // todo ? ifDebug == dev --> exposer les getters etc...
  return {
    getParametresUrlOris: function () { return PARAMETRES_URL_ORIS; },
    parametresUrlOrisNoFunction: function () { return PARAMETRES_URL_ORIS_NO_FUNCTIONS; },
    getWorker: function () { return WORKER; },
    getLoadingSpinnerHandler: function () { return LOADING_OVERLAY_HANDLER; },
    getGanttRenderingModule: function(){ return GANTT_RENDERING_MODULE; },
    getChart: function () { return APP_MODULE.getGanttRenderingModule().getChart(); }
  }
})();